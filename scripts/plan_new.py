...
#python scripts/plan_new.py --config config.maze2d --dataset maze2d-large-v1
...
if USE_CBF:
    ...
    if hasattr(maze_env, 'maze_arr'):
        ...
        print(f"已同步环境中的 {len(real_walls)} 个墙壁坐标")
...
json_data = {
    'average_score': np.mean(score_batch),
